...
def LR_2(points, selected_edges, stc, stic, ec, lamda, beeta, speed, capacity, demand, source, destination, commodities):
    ...
    if prob.status == -1:  # Infeasible
        ...
        return pulp.value(prob.objective), {(k, i, j): f[k, i, j].varValue for (k, i, j) in f.keys()}

def Solution_Zlb(points, selected_edges, stc, stic, ec, lambda_n, speed, capacity, demand, alpha, beta, source, destination, commodities):
  print(selected_edges)
  lr1_result, yij = LR_1(points, selected_edges, stc, stic, ec, lambda_n, alpha, commodities)
  lr2_result, fij = LR_2(points, selected_edges, stc, stic, ec, lambda_n, beta, speed, capacity, demand, source, destination, commodities)
